...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <h2 class="text-2xl font-bold text-white">Edit Admin Wisata</h2>
                <p class="mt-1 text-lg text-gray-400">Perbarui data admin wisata</p>
            </div>
        ...
        <div class="p-6 border rounded-xl bg-gray-800/50 border-white/10">
            <form action="{{ route('superadmin.admin-wisata.update', $adminWisata->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $adminWisata->name) }}"
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $adminWisata->email) }}"
                        class="w-full px-4 py-2.5 text-base bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500/30 focus:border-green-500 text-gray-900 placeholder:text-gray-500"
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" value="{{ old('phone', $adminWisata->phone) }}"
                        class="w-full px-4 py-2.5 text-base bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500/30 focus:border-green-500 text-gray-900 placeholder:text-gray-500"
