...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <h2 class="text-2xl font-bold text-white">Tambah Tempat Wisata</h2>
                <p class="mt-1 text-lg text-gray-400">Tambah data tempat wisata baru</p>
            </div>
        ...
        <div class="p-6 border rounded-xl bg-gray-800/50 border-white/10">
            <form action="{{ route('superadmin.wisata.store') }}" method="POST" class="space-y-6">
                @csrf
