    ...
    <div class="px-4 mx-auto space-y-10 max-w-7xl">
        ...
        <div class="flex flex-col gap-4 mb-6 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin-wisata.wisata.edit', $wisata->id) }}"
                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white transition-colors bg-yellow-500 rounded-lg hover:bg-yellow-600">
                    <i class="mr-2 fa-solid fa-pen-to-square"></i>
                    Edit Tempat Wisata
                </a>
                <a href="{{ route('admin-wisata.tempat-wisata.gambar') }}?tab=gambar"
        ...
        @else
            <div class="flex items-center justify-center mb-8 border h-60 bg-gray-800/50 border-white/10 rounded-xl">
                <span class="text-lg text-gray-400">Belum ada gambar untuk tempat wisata ini.</span>
            </div>
        @endif
