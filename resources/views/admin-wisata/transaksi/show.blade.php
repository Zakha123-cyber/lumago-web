    ...
    <div class="flex justify-center items-center min-h-[80vh]">
        <div
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <div class="text-sm text-gray-400">Nota Transaksi Tiket</div>
            </div>
            ...
            {{-- QR Code (jika ada) --}}
            @if (!empty($transaksi->qr_code_path))
                <div class="flex flex-col items-center mb-6">
            ...
            <div class="flex justify-center mt-6">
                <a href="{{ route('admin-wisata.transaksi.index') }}"
                    ...
                    <i class="mr-2 fa-solid fa-arrow-left"></i> Kembali ke Daftar Transaksi
                </a>
            </div>
            ...
            <div class="mt-8 text-xs text-center text-gray-500">
                ...
                <span class="text-green-500">--- {{ now()->format('d M Y H:i') }} ---</span>
            </div>
        </div>
    </div>
@endsection
